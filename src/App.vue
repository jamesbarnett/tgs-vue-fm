...
<template>
  <div class="card-container">
    <Card
      ...
      student="Daniel Clifford"
      status="Verified Graduate"
      summary="I received a job offer mid-course, and the subjects I learned were
    ...
    />
    <Card
      data-accent="grayblue"
      data-gridarea="b"
      image="./images/image-jonathan.jpg"
      student="Jonathan Walters"
      status="Verified Graduate"
      summary="The team was very supportive and kept me motivated"
      testimonial="“ I started as a total newbie with virtually no coding skills. I now
    ...
    <Card
      data-accent="white"
      data-gridarea="d"
      student="Jeanette Harmon"
      image="./images/image-jeanette.jpg"
      status="Verified Graduate"
      summary="An overall wonderful and rewarding experience"
      testimonial="“ Thank you for the wonderful experience! I now have a job I really
      enjoy, and make a good living while doing something I love. ”"
    />
    <Card
      data-accent="blackblue"
      data-gridarea="e"
      image="./images/image-patrick.jpg"
      student="Patrick Abrams"
      status="Verified Graduate"
      ...
      testimonial="“ The staff seem genuinely concerned about my progress which I find
    ...
    <Card
      ...
      student="Kira Whittle"
      status="Verified Graduate"
      summary="Such a life-changing experience. Highly recommended!"
      testimonial="“ Before joining the bootcamp, I’ve never written a line of code. I
